...
@section('title', 'SPKPN | Modul I')

@section('content_header')
<h1><div class="d-inline p-1 bg-blue text-white">MODUL I : KESEJAHTERAAN KAMPUNG</div></h1>
<h3><div class="d-inline p-1 bg-black text-white">Kursus/Latihan Yang Telah Dihadiri Oleh Institusi Kepimpinan Kampung</div></h3>

...
class ModulLController extends Controller
{
    ...
    public function isu(Request $request)
    {
        ...
        ->leftJoin('t_l_status_masalah','t_kampung.kam_idkampung','=','t_l_status_masalah.stm_idkampung')
        ->select('t_kampung.kam_idkampung as id','t_kampung.kam_nama_kampung as kampung')->distinct('t_kampung.kam_idkampung')
        ->where('t_l_status_masalah.stm_idkampung','=', NULL);
        ...
        return view('modul_l.isu',compact('negeri','agensikawalselia','chartmodulb','senaraiIsi','senaraiBelumIsi','jumBelumIsi','jumTotal'))->with('no',1);
    }
}

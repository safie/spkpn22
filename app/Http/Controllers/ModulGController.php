...
class ModulGController extends Controller
{
    ...
    public function rumah(Request $request)
    {
        ...
        ->leftJoin('t_g_hakmilik_penduduk','t_kampung.kam_idkampung','=','t_g_hakmilik_penduduk.hak_idkampung')
        ->select('t_kampung.kam_idkampung as id','t_kampung.kam_nama_kampung as kampung')->distinct('t_kampung.kam_idkampung')
        ->where('t_g_hakmilik_penduduk.hak_idkampung','=', NULL);
        ...
        return view('modul_g.rumah',compact('negeri','agensikawalselia','chartmodulb','senaraiIsi','senaraiBelumIsi','jumBelumIsi','jumTotal'))->with('no',1);
    }
    ...
    public function kenderaan(Request $request)
    {
        ...
        //$totalKampung = Kampung::count();
        $listkg_belumisi = DB::connection('mysql2')->table('t_kampung')->where('kam_idstatus_kampung','1')
        ->leftJoin('t_g_kenderaan','t_kampung.kam_idkampung','=','t_g_kenderaan.ken_idkampung')
        ->select('t_kampung.kam_idkampung as id','t_kampung.kam_nama_kampung as kampung')->distinct('t_kampung.kam_idkampung')
        ->where('t_g_kenderaan.ken_idkampung','=', NULL);
        ...
        return view('modul_g.kenderaan',compact('negeri','agensikawalselia','chartmodulb','senaraiIsi','senaraiBelumIsi','jumBelumIsi','jumTotal'))->with('no',1);
    }

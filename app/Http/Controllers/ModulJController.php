...
class ModulJController extends Controller
{
    ...
    public function organisasi(Request $request)
    {
        ...
        ->leftJoin('t_j_organisasi','t_kampung.kam_idkampung','=','t_j_organisasi.org_idkampung')
        ->select('t_kampung.kam_idkampung as id','t_kampung.kam_nama_kampung as kampung')->distinct('t_kampung.kam_idkampung')
        ->where('t_j_organisasi.org_idkampung','=', NULL);
        ...
        return view('modul_j.organisasi',compact('negeri','agensikawalselia','chartmodulb','senaraiIsi','senaraiBelumIsi','jumBelumIsi','jumTotal'))->with('no',1);
    }
}

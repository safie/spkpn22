...
class ModulBController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        //-- Carta --//
        //1-Dapatkan data //
        $totalKgModul = SejarahMoto::distinct('sej_idkampung')->count();
        ...
        return view('modul_b.index',compact('negeri','agensikawalselia','chartmodulb','senaraiIsi','senaraiBelumIsi','jumBelumIsi','jumTotal'))->with('no',1);
    }

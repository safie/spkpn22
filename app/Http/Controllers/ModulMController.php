...
class ModulMController extends Controller
{
    ...
    public function kursus(Request $request)
    {
        ...
        ->leftJoin('t_m_kursus_diperlukan','t_kampung.kam_idkampung','=','t_m_kursus_diperlukan.kud_idkampung')
        ->select('t_kampung.kam_idkampung as id','t_kampung.kam_nama_kampung as kampung')->distinct('t_kampung.kam_idkampung')
        ->where('t_m_kursus_diperlukan.kud_idkampung','=', NULL);
        ...
        return view('modul_m.kursus',compact('negeri','agensikawalselia','chartmodulb','senaraiIsi','senaraiBelumIsi','jumBelumIsi','jumTotal'))->with('no',1);
    }
}
